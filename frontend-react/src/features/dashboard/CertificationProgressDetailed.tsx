...
const PRIVATE_REQUIREMENTS: DetailedRequirement[] = [
  ...
  },
  {
    ...
    description:
      "One solo cross country flight of at least 150 nautical miles total distance, with full stop landings at three points, and one segment of more than 50 nautical miles between takeoff and landing.",
    required: 1,
    unit: "flight",
  ...
  },
  {
    ...
    details: (hours) =>
      hours.private_towered_ops >= 3 ? (
        <div className="text-xs text-slate-400 mt-1">
          4/3 takeoffs completed
          <br />
...
const IR_REQUIREMENTS: DetailedRequirement[] = [
  ...
  },
  {
    ...
    description:
      "40 hours of actual or simulated instrument time (BATD hours included, total simulator hours included).",
    required: 40,
    unit: "hours",
  ...
  },
  {
    ...
    description:
      "Three hours of instrument flight training from an authorized instructor in an airplane within 2 calendar months before the practical test.",
    required: 3,
    unit: "hours",
  ...
  },
  {
    ...
    description:
      "One 250nm instrument cross-country training flight in an airplane with an instrument approach at each airport and three different kinds of approaches.",
    required: 1,
    unit: "flight",
...
const CFI_REQUIREMENTS: DetailedRequirement[] = [
  ...
  },
  {
    ...
    description:
      "100 hours of cross-country flight time as pilot in command, or as a rated pilot with at least 50 hours in airplanes.",
    required: 100,
    unit: "hours",
    calculate: (hours) => hours.pic_xc,
  },
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center justify-between mb-2">
                ...
                {isComplete && <span className="text-truehour-green text-xs font-medium">Complete</span>}
              </div>
